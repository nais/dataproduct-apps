...
def _init_bq(settings: Settings):
    ...
    schema = [
        ...
        bigquery.SchemaField(
            name="uses_auto_instrumentation", field_type="BOOL", mode="nullable"
        ),
        bigquery.SchemaField(name="uses_loki_logs", field_type="BOOL", mode="nullable"),
        bigquery.SchemaField(name="inbound_apps", field_type="STRING", mode="repeated"),
        bigquery.SchemaField(
            name="outbound_apps", field_type="STRING", mode="repeated"
        ),
        bigquery.SchemaField(
            name="outbound_hosts", field_type="STRING", mode="repeated"
        ),
